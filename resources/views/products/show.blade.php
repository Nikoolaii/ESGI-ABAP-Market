            ...
            <div class="col-xl-12">
                <div class='card shadow-lg col-sm border pt-5'>
                    <div class='col-xl-11 col-sm mx-auto'>
                            <div class="col-xl">
                                ...
                                <div class="mx-auto text-center">
                                    <img src='{{ $product->image }}' class='img-fluid' style="height: 300px; width: auto;" alt="{{ $product->name }}"  >
                                </div>
                            </div>
                        <div class='d-flex' style='height: 20px;'></div>
                        <div class="col-xl-8 col-sm">
                            <h1 class="card-title pb-1"></h1>
                        </div>
                        <div class='d-flex' style='height: 20px;'></div>
                    ...
                    <div class='col-xl-11 col-sm mx-auto'>
                        ...
                        <div class='d-flex' style='height: 20px;'></div>
                        <p class='h3 text-dark'>Disponibility : {{ $product->stock}}  {{ $product->name }} in stock !</p>
                        <div class='d-flex' style='height: 20px;'></div>
                    </div>
